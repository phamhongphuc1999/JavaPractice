...
import com.example.entity.dto_utils.NewSupplier;
...
public class Supplier {
  ...
  public Supplier(String name, String address, String phone, String email, String moreInfo, Date contractDate) {
    this.name = name;
    this.address = address;
    this.phone = phone;
    this.email = email;
