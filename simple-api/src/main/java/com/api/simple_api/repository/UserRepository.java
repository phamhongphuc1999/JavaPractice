...
public interface UserRepository extends JpaRepository<User, Long> {
  @Query("SELECT new com.api.simple_api.entity.dto_utils.ResultUser(u.id, u.displayName, u.username, u.password, u.roleId, ur.displayName) FROM User u LEFT JOIN UserRole ur ON ur.id=u.roleId WHERE " +
